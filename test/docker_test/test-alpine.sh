...
# Install SASL runtime for proton PLAIN authentication.
# cyrus-sasl-dev is in the deps image (so proton is built with SASL support);
# we need the runtime library here.
